...
class ASTModel(nn.Module):
    def __init__(self, num_classes,
        ...
        # Use a pretrained models for finetuning
            ...
            audio_model = ASTModel(num_classes, fstride=p_fshape, tstride=p_tshape, fshape=p_fshape, tshape=p_tshape,
    ...
    def get_embeddings(self, input_tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        """
        input_tensor=self.preprocess(input_tensor, input_tdim=self.input_tdim) # Convert to spectrogram
